...
SRC_URI = "\
       ...
       file://0007-Add-secondary-input-device-for-search-operation-TOUC.patch \
       ...
       file://0013-Add-a-secondary-device-for-search-operation-to-cover.patch \
...
do_install() {
    install -d ${D}/usr/bin
    install -d ${D}/etc/libinput/
    install -m 0755 ${S}/lvgldemo_32* ${D}/usr/bin/
    install -m 0755 ${S}/lvgldemo_16* ${D}/usr/bin/
    install -m 0644 ${WORKDIR}/local-overrides.quirks ${D}/etc/libinput/
